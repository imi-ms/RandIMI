...
public class StrataInfoResponseV2 {

	@JsonProperty
	@Schema(description = "Definitions of all strata in the study.",
	        example = "[{\"name\":\"Color\",\"apiId\":\"Color\",\"type\":\"ENUM\",\"values\":[{\"name\":\"red\",\"apiId\"\"red\"},{\"name\":\"blue\",\"apiId\"\"blue\"},{\"name\":\"green\",\"apiId\"\"green\"}]}]")
...
//    }
	...
	@Value
	@Schema(description = "Describes a value of an enumerated stratum.")
	public static class FactorValue {
		@Schema(description = "Name of the Value")
		String name;
		@Schema(description = "API ID of the Value")
		String apiId;
	}
